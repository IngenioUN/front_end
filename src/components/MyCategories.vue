<template>
    <div class="divlogin">
        <div class="row">
          <div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10" v-for="item of categories" :key="item.id">
            <div class="row no-gutters mb-3">
              ...
              <div class="col-md-7 text-left">
                <div class="card-body">
                  ...
                  Description...
                  <br/>
                  <!-- <b-button class="mt-2 btn btn-sm" variant="outline-dark" v-if="isSubscribed" @click="subscribe(item._id)" >Susbcribe</b-button>
                  <b-button class="mt-2 btn btn-sm" variant="outline-dark" v-if="!isSubscribed" @click="unsubscribe(item._id)">Unsusbcribe</b-button> -->
                  <b-button class="mt-2 btn btn-sm" variant="outline-dark" @click="subscribe(item._id)" >Susbcribe</b-button>
                  <b-button class="mt-2 btn btn-sm" variant="outline-dark" @click="unsubscribe(item._id)">Unsusbcribe</b-button>
                  &nbsp;
